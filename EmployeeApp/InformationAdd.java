				...
				if (comboBox.getSelectedItem().equals("1111")) {
					try {
						...
						BufferedReader readerEmp = new BufferedReader(new FileReader(
								"C:\\Users\\clari\\eclipse-workspace\\MotorPH_Homework6(Final)\\src\\Files\\employee1111.csv"));
						...
						BufferedReader readerPay = new BufferedReader(new FileReader(
								"C:\\Users\\clari\\eclipse-workspace\\MotorPH_Homework6(Final)\\src\\Files\\payroll1111.csv"))) {
							// Reads the CSV file data separated by "," and display the data to their
							// respective textfields
						...
						BufferedReader readerLeave = new BufferedReader(new FileReader(
								"C:\\Users\\clari\\eclipse-workspace\\MotorPH_Homework6(Final)\\src\\Files\\leaves1111.csv"))) {
						...
						lblProfilePic.setIcon(new ImageIcon(
								"C:\\Users\\clari\\eclipse-workspace\\MotorPH_Homework6(Final)\\src\\Icons\\male.png"));
					...
					try {
						// Reads the CSV file from local directory
						BufferedReader readerEmp = new BufferedReader(new FileReader(
								"C:\\Users\\clari\\eclipse-workspace\\MotorPH_Homework6(Final)\\src\\Files\\employee2222.csv"));
						...
						try (// Payroll
												// Reads the CSV file from local directory
						BufferedReader readerPay = new BufferedReader(new FileReader(
								"C:\\Users\\clari\\eclipse-workspace\\MotorPH_Homework6(Final)\\src\\Files\\payroll2222.csv"))) {
							// Reads the CSV file data separated by "," and display the data to their
							// respective textfields
							String linePay = readerPay.readLine();
							String[] dataPay = linePay.split(",");
						...
						try (// Leaves
						BufferedReader readerLeave = new BufferedReader(new FileReader(
								"C:\\Users\\clari\\eclipse-workspace\\MotorPH_Homework6(Final)\\src\\Files\\leaves2222.csv"))) {
							String lineLeave = readerLeave.readLine();
							String[] dataLeave = lineLeave.split(",");
							txtSick.setText(dataLeave[0]);
							txtVacation.setText(dataLeave[1]);
						...
						lblProfilePic.setIcon(new ImageIcon(
								"C:\\Users\\clari\\eclipse-workspace\\MotorPH_Homework6(Final)\\src\\Icons\\female.png"));
					...
					lblProfilePic.setIcon(new ImageIcon(
							"C:\\Users\\clari\\eclipse-workspace\\MotorPH_Homework6(Final)\\src\\Icons\\blank.png"));
				}
			}
		});
						...
						try {
							...
							while (line != null) {
								...
								if (leaveCount > 0) {
									...
									try {
										BufferedWriter writer = new BufferedWriter(new FileWriter(
												"C:\\Users\\clari\\eclipse-workspace\\MotorPH_Homework6(Final)\\src\\Files\\leaveApplication.csv",
												true));
